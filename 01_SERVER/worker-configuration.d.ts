/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: da617dbfc825c38f68670a8d6f3e9157)
...
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		CORS_ORIGIN: "http://localhost:5173,http://localhost,capacitor://localhost,https://photo.jeonghyeon.net";
		FIREBASE_PROJECT_ID: "photo-canon";
	}
}
